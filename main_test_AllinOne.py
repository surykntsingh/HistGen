...
def parse_agrs():
    ...
    parser.add_argument('--save_dir', type=str, default='results/REG/2/', help='the patch to save the models.')
    parser.add_argument('--record_dir', type=str, default='records/REG/2/', help='the patch to save the results of experiments')
    parser.add_argument('--load', type=str, default='results/REG/2/', help='whether to load a pre-trained model.')
